...
\thispagestyle{empty}
\begin{abstract}
This report  describes our project  for the course 2IV05 Additional Component Computer Graphics, in which we will design and implement a 3D bridge building application.
\end{abstract}
